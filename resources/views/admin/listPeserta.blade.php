                                    ...
                                    @if ($peserta->is_validated == 0)
                                        <form action="{{ route('admin.validate') }}" method="post"
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                class="focus:outline-none text-black bg-yellow-400 hover:bg-yellow-500 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:ring-yellow-900">Validate</button>
                                        </form>
                                    @else
                                        Already Validated
                                    @endif
