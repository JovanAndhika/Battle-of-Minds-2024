...
@section('content')
    ...
    <div class="winner-container flex flex-row justify-around mt-[100px] mb-0">
        <div class="p-5 mb-10 mt-28 w-1/4 bg-pink-500 rounded-lg">
            ...
            <h5 class="text-white text-2xl flex justify-end self-end">Poin : {{ $second->jumlahPoin }}
            </h5>
        </div>
        <div
            ...
            <h5 class="text-white text-3xl flex justify-end self-end">Poin : {{ $first->jumlahPoin }}
            </h5>
        </div>
        <div class="p-5 mb-10 mt-28 w-1/4 bg-blue-500 rounded-lg">
            ...
            <h5 class="text-white text-2xl flex justify-end self-end">Poin: {{ $third->jumlahPoin }}
            </h5>
        </div>
    </div>
