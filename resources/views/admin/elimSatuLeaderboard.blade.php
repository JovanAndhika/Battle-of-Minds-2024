...
@section('content')
    ...
    <div class="winner-container flex flex-row justify-around mt-[100px] mb-0">
        <div class="p-5 my-10 w-1/4 bg-pink-500 rounded-lg">
            ...
            <h5 class="text-white flex justify-end self-end">Poin : {{ $second->poin }}</h5>
        </div>
        <div
            ...
            <h5 class="text-white flex justify-end self-end">Poin : {{ $first->poin }}</h5>
        </div>
        <div class="p-5 my-10 w-1/4 bg-blue-500 rounded-lg">
            ...
            <h5 class="text-white flex justify-end self-end">Poin: {{ $third->poin }}</h5>
        </div>
    </div>
