                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-floating">
                            <input type="text" id="kontakSekolah" name="kontakSekolah"
                                ...
                                placeholder="Masukkan kontak sekolah" value="{{ old('kontakSekolah') }}" required>
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control @error('usernameKelompok') is-invalid @enderror"
                                id="usernameKelompok" name="usernameKelompok" placeholder="Masukkan username kelompok"
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-floating">
                            <input type="password" id="inputPassword5"
                                ...
                                aria-describedby="passwordHelpBlock" placeholder="Masukkan password"
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-floating">
                            <input type="password" id="inputConfirmPassword5" class="form-control"
                                ...
                                placeholder="Masukkan confirm password" value="{{ old('passConfirmPeserta') }}" required>
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control @error('namaKetua') is-invalid @enderror"
                                id="namaKetua" name="namaKetua" placeholder="Masukkan nama ketua"
                                value="{{ old('namaKetua') }}" required>
                            <label for="namaKetua">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-floating">
                            <input type="email" class="form-control @error('emailKetua') is-invalid @enderror"
                                id="emailKetua" name="emailKetua" placeholder="example@gmail.com"
                                value="{{ old('emailKetua') }}" required>
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-floating">
                            <input type="text" id="namaKedua" name="namaKedua"
                                class="form-control @error('namaKedua') is-invalid @enderror"
                                placeholder="Masukkan nama member 2" value="{{ old('namaKedua') }}" required>
                            <label for="namaKedua">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-users-round">
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-floating">
                            <input type="text" id="namaKetiga" name="namaKetiga"
                                class="form-control @error('namaKetiga') is-invalid @enderror"
                                placeholder="Masukkan nama member 3" value="{{ old('namaKetiga') }}" required>
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-floating">
                            <input type="text" id="kerabatTiga" name="kerabatTiga"
                                class="form-label form-control @error('kerabatTiga') is-invalid @enderror"
                                placeholder="Masukkan kontak kerabat" value="{{ old('kerabatTiga') }}" required>
