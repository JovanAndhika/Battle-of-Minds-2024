            ...
            <form method="POST" action="{{ route('storeRegistration') }}" enctype="multipart/form-data"
                    ...
                    <div class="mb-3 col-xl-full">
                        <div class="floating-label">
                            <input type="text" id="kontakSekolah" name="kontakSekolah"
                                ...
                                value="{{ old('kontakSekolah') }}" required>
                    ...
                    <div class="mb-3 col-xl-full">
                        <div class="floating-label">
                            <input type="text" class="form-control @error('kontakPerwakilan') is-invalid @enderror"
                                ...
                                value="{{ old('kontakPerwakilan') }}" required>
                ...
                <div class="row">
                    <div class="mb-3 col-xl-full">
                        <div class="floating-label">
                            <input type="password" id="confirmPass"
                                ...
                                aria-describedby="passwordHelpBlock" placeholder="" value="{{ old('confirmPass') }}"
                                required>
                        ...
                        <div class="mb-3 col-md-6 nama-ketua-container">
                            <div class="floating-label">
                                <input type="text" class="form-control @error('namaKetua') is-invalid @enderror"
                                    id="namaKetua" name="namaKetua" placeholder="" value="{{ old('namaKetua') }}"
                                    required>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="alergi" class="form-label alergi-label">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shield-plus">
                                    <path
                    ...
                    <button type="submit" id="btn-submit"
                        class="submit-button btn btn-primary btn-lg mt-2">SUBMIT</button>
            </form>
        </div>
    </div>
