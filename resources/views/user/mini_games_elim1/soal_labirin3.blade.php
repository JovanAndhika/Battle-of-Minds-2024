...
<div class="w-screen h-screen flex flex-col justify-center items-center">
    <div class="container h-[300px] flex flex-col justify-center items-center">
        <div class="form-box">
            <form method="post" action="/checkAnswer3" autocomplete="off">
                @csrf
                @php
                $questions = [
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="question_{{ $i  }}" name="question_{{ $i }}" placeholder="Answer here" value="{{ old('question_' . ($i)) }}" autocomplete="off" style="color: black;">
