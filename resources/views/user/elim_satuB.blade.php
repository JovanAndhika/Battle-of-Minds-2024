...
@section('form_soal')
    ...
    <form method="POST" action="{{ route('user.simpan_jawabanB') }}" id="simpan-jawaban" class="form-simpan-jawaban" autocomplete="off">
        @csrf
        <div id="question-container">
            ...
            @foreach ($data_jawaban as $data)
                @if ($data->kunci_jawabans_id >= 51 && $data->kunci_jawabans_id <= 100)
