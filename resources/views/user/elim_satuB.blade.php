...
<body>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            for (var angka = 51; angka <= 100; angka++) {
                cekNilai(angka);
            }
        });
    ...
    <div class="container">
        ...
        <div class="mx-md-5 form-content mb-5">
            <div id="question-container" class="ms-md-3 question">
                <form method="POST" action="{{ route('user.simpan_jawabanB') }}" id="simpan-jawaban" class="form-simpan-jawaban">
                    @csrf
                    ...
                    @if (($data->kunci_jawabans_id) >= 51 && ($data->kunci_jawabans_id) <= 100) <div id="page-2" class="page">
